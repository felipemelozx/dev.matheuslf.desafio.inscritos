...
class ProjectMapperTest {
  ...
  void shouldMapRequestProjectToProjectModel() {
    ...
    ProjectModel projectModel = projectMapper.toProjectModel(request, new UserModel().setId(1L));

    assertNull(projectModel.getId());
    assertNotNull(projectModel.getCreatedBy());
  ...
  void shouldMapProjectModelToResponseProject() {
    ...
    ProjectModel project = new ProjectModel(1L, "Projeto A", "Desc", new Date(), new Date(), userModel);
  ...
  void shouldMapListOfProjectModelToResponseProjectList() {
    UserModel userModel = new UserModel().setId(1l);
    ProjectModel project1 = new ProjectModel(1L, "Projeto A", "Desc", new Date(), new Date(), userModel);
    ProjectModel project2 = new ProjectModel(2L, "Projeto B", "Desc B", new Date(), new Date(), userModel);
